        ...
        <div class="item" v-for="item in $store.getters['cart/validList']" :key="item.skuId">
          <RouterLink :to="`/product/${item.id}`">
            ...
            <div class="right">
              ...
              <p class="count">x{{item.orderNum}}</p>
            </div>
          </RouterLink>
          <i class="iconfont icon-close-new" @click="deleteCartGood(item.skuId)"></i>
        </div>
      </div>
